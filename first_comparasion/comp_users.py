...
def compare_users(user1, user2):
    result = {}
    coin_challenges = compare_challenge(user1.challenges, user2.challenges)
    coin_languages = compare_languages(user1.preferred_languages, user2.preferred_languages)
    ...
    coin_team_size = compare_group_size(user1.preferred_team_size, user2.preferred_team_size)
    coin_prev_hack = compare_datathons(user1.hackatons_done, user2.hackatons_done)
